...
import kirupa.com.credit.AlarmReceiver;
import kirupa.com.credit.Constants;
import kirupa.com.credit.R;
import kirupa.com.credit.adapters.ViewPagerAdapter;
import kirupa.com.credit.adapters.WeatherRecyclerAdapter;
import kirupa.com.credit.fragments.RecyclerViewFragment;
import kirupa.com.credit.models.Weather;
import kirupa.com.credit.tasks.GenericRequestTask;
import kirupa.com.credit.tasks.ParseResult;
import kirupa.com.credit.tasks.TaskOutput;
import kirupa.com.credit.utils.UnitConvertor;
import kirupa.com.credit.widgets.AbstractWidgetProvider;
import kirupa.com.credit.widgets.DashClockWeatherExtension;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherFont = Typeface.createFromAsset(this.getAssets(), "fonts/roboto_regular.ttf");
    ...
    private void aboutDialog() {
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("Forecast");
        final WebView webView = new WebView(this);
        String about = "<p>1.6.1</p>" +
                "<p>A lightweight, opensource weather app.</p>" +
                "<p>Developed by <a href='mailto:kirupakaran1291@gmail.com'>Kirupakaran</a></p>" +
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_share) {
            if (isNetworkAvailable()) {
                ...
                Log.d("MainActivity","actionshare");
//                getTodayWeather();
//                getLongTermWeather();

               String Temperature = todayTemperature.getText().toString();
               String Description= todayDescription.getText().toString();
               String Wind= todayWind.getText().toString();
               String Pressure= todayPressure.getText().toString();
               String Humidity= todayHumidity.getText().toString();
               String Sunrise= todaySunrise.getText().toString();
               String Sunset= todaySunset.getText().toString();

                openWhatsApp(Temperature,Description,Wind,Pressure,Humidity,Sunrise,Sunset);
    ...
    private void openWhatsApp(String temperature, String description, String wind, String pressure, String humidity, String sunrise, String sunset) {

        String toNumber = "+91 8870890160"; // contains spaces.
        toNumber = toNumber.replace("+", "").replace(" ", "");

        Intent sendIntent = new Intent("android.intent.action.MAIN");
        sendIntent.putExtra("jid", toNumber + "@s.whatsapp.net");
        sendIntent.putExtra(Intent.EXTRA_TEXT, "Temperature:"+temperature+"\n"+"Description:"+description+"\n"+wind+"\n"+pressure+"\n"+
                humidity+"\n"+sunrise+"\n"+sunset);
