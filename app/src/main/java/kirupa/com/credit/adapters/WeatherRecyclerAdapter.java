package kirupa.com.credit.adapters;
...
import kirupa.com.credit.activities.MainActivity;
import kirupa.com.credit.models.Weather;
import kirupa.com.credit.models.WeatherViewHolder;
...
public class WeatherRecyclerAdapter extends RecyclerView.Adapter<WeatherViewHolder> {
    ...
    public void onBindViewHolder(WeatherViewHolder customViewHolder, int i) {
        ...
        Typeface weatherFont = Typeface.createFromAsset(context.getAssets(), "fonts/roboto_regular.ttf");
